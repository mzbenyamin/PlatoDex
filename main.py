...
کاربرا رو تشویق کن به کانال <a href='https://t.me/salatin_plato'>@salatin_plato</a> بپیوندن تا اخبار و ترفندای خفن پلاتو رو ببینن! 🚀\n\n
<b>حذف اکانت</b>\n
<b>چطور اکانتمو حذف کنم؟</b>\nبرای حذف اکانت این مراحل رو برو:\n
...
<b>چرا اومده؟</b>\nبرای کم کردن رفتارای منفی. راهای قبلی جواب نداد، این بهتر کار کرده.\n
...
<b>چطور بگیرم؟</b>\n<ul><li>قبل 5 دسامبر 2022 اگه 2000 سکه خریده یا گیفت گرفته باشی، داری</li><li>اکانت جدید یا از 16 ژوئن 2023 لاگین نکردی؟ 7 روز وقت داری Welcome Offer رو از Shop بخری</li><li>از Shop تو قسمت بج‌ها بخر</li><li>از دوستات بخواه گیفتت کنن</li></ul>
<b>چطور استفاده کنم؟</b>\nفقط باید داشته باشیش، لازم نیس فعالش کنی.\n\n
<b>مبارزه با سوءاستفاده</b>\n
<b>پلاتو برای سوءاستفاده چیکار می‌کنه؟</b>\nهدفش اینه همه بدون اذیت بازی کنن:\n
...
<b>چطور سوءاستفاده رو گزارش بدم؟</b>\n<ul><li>بلاک و گزارش کن، چت ضبط می‌شه</li><li>تو گروه خصوصی به ادمین بگو یا لفت بده</li><li>اگه ادامه داشت ایمیل بزن: Plato ID خودت و طرف، توضیح ماجرا، ویدیو اگه داری</li></ul>\n
<b>اکانت و پروفایل</b>\n
<b>چرا نمی‌تونم با ایمیلم ثبت‌نام کنم؟</b>\n<ul><li>ایمیلتو چک کن</li><li>شاید قبلا ثبت شده، لاگین کن</li><li>یه ایمیل دیگه امتحان کن</li><li>مشکل داری؟ به <a href='mailto:hello@platoapp.com'>hello@platoapp.com</a> بگو</li></ul>
<b>ثبت‌نام نکردم، چطور لاگین کنم؟</b>\nنمی‌شه، باید ایمیل ثبت کرده باشی.\n
<b>به ایمیلم دسترسی ندارم، چطور لاگین کنم؟</b>\nنمی‌شه، باید ایمیلتو برگردونی.\n
<b>چرا نمی‌تونم با ایمیلم لاگین کنم؟</b>\n<ul><li>ایمیلتو چک کن</li><li>اگه زیاد درخواست دادی 24 ساعت صبر کن</li><li>مشکل داری؟ ایمیل بزن</li></ul>
<b>چطور ایمیلمو عوض کنم؟</b>\nنمی‌شه، برای امنیت ثابته.\n
<b>پیامای خصوصیمو چطور برگردونم؟</b>\nنمی‌شه، برای حریم خصوصی ذخیره نمی‌شن.\n
<b>چرا عکس پروفایلم رد شد؟</b>\nاحتمالا محتوای بد داره، یه عکس دیگه بذار.\n
<b>چرا نمی‌تونم عکس پروفایلمو عوض کنم؟</b>\nروزی 4 بار می‌شه، صبر کن.\n
<b>چرا Plato IDم رد شد؟</b>\nکلمه بد داره یا Pips می‌خواد.\n
<b>چرا نمی‌تونم Plato IDمو دوباره عوض کنم؟</b>\nشاید در دسترس نباشه یا قوانین رو نقض کنه.\n
<b>ID قبلیم کی آزاد می‌شه؟</b>\nبین 24 تا 72 ساعت تصادفیه.\n
<b>IDم تو انتقال دزدیده شد، برمی‌گردونین؟</b>\nپلاتو انتقال رو ساپورت نمی‌کنه، ریسک خودته.\n
<b>یه ID غیرفعال می‌خوام، آزاد می‌کنین؟</b>\nگاهی آزاد می‌کنن، ولی درخواستی نه.\n
<b>PlatoBot رو چطور از لیست دوستام پاک کنم؟</b>\nنمی‌شه، مهربونه!\n
<b>آیتم رو از inventoryم چطور پاک کنم؟</b>\nنمی‌شه، دائميه.\n
<b>چرا سکه‌هام غیبشون زد؟</b>\nشاید ریفاند درخواست دادی، ایمیل بزن.\n
<b>چطور ببینم کی به اکانتم لاگینه؟</b>\nبرو ⚙️ > Devices.\n\n
<b>امنیت و حریم خصوصی</b>\n
<b>کی می‌تونه منو آنلاین ببینه؟</b>\nدوستات و حریفات، اگه نمی‌خوای برو ⚙️ > Privacy > Show Online to Friends رو خاموش کن.\n
<b>چطور بلاک کنم؟</b>\nرو پروفایل طرف بزن و Block رو انتخاب کن. چتشون قطع می‌شه و نمی‌تونن بازیاتو جوین کنن.\n
<b>سیاست حریم خصوصی چیه؟</b>\nخیلی جدیه، اینجا بخون: <a href='https://platoapp.com/privacy'>Privacy Policy</a>\n\n
<b>لینکای دانلود پلاتو</b>\n<ul><li>اندروید: <a href='https://play.google.com/store/apps/details?id=com.plato.android'>دانلود</a></li><li>iOS: <a href='https://apps.apple.com/app/plato-play-chat-together/id1054747306?ls=1'>دانلود</a></li><li>ویندوز: <a href='https://platoapp.com/downloads'>دانلود</a></li></ul>\n
<b>سلاطین پلاتو چیه؟</b>\nاولین رسانه فارسی‌زبون پلاتو از 1400 با مدیریت بنیامین. اخبار و ترفندای پلاتو رو می‌دن و یه مینی‌اپ تلگرامی <a href='https://t.me/PlatoDex'>@PlatoDex</a> دارن که رتبه‌بندی بازیکنا و آیتما رو نشون می‌ده. رباتشون: <a href='https://t.me/saIatin_Robot'>@saIatin_Robot</a> - کانال: <a href='https://t.me/salatin_plato'>@salatin_plato</a> - گروه: <a href='https://t.me/Gap_Plato'>@Gap_Plato</a>\n\n
<b>چند اکانت تو یه دستگاه</b>\n
1️⃣ <b>تغییر دستی</b>: لاگین کن، لفت بده، با ایمیل دیگه بیا، حواست به ثبت اطلاعات باشه.\n
2️⃣ <b>نسخه افلاطون</b>: کنار نسخه اصلی نصب کن، از ربات بگیر.\n
3️⃣ <b>Plato Mage</b>: از <a href='https://t.me/saIatin_Robot?start=cmd_789829938'>اینجا</a> بگیر، یه اکانت دیگه کنار اصلی می‌ده.\n
4️⃣ <b>Apk Editor</b>: آموزشش تو رباته، چند نسخه می‌تونی بسازی.\n
5️⃣ <b>پلاتو باکس</b>: کلونر نصب کن، ولی مواظب رم گوشیت باش.\n
