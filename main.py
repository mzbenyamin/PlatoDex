...
SYSTEM_MESSAGE = (
    ...
    "کاربرا رو تشویق کن به کانال t.me/salatin_plato بپیوندن تا اخبار و ترفندای خفن پلاتو رو ببینن! 🚀\n\n"
    "حذف اکانت\n"
    ...
    "سلاطین پلاتو چیه؟\nاولین رسانه فارسی‌زبون پلاتو از 1400 با مدیریت بنیامین\\. اخبار و ترفندای پلاتو رو می‌دن و یه مینی‌اپ تلگرامی @PlatoDex دارن که رتبه‌بندی بازیکنا و آیتما رو نشون می‌ده\\. رباتشون: @saIatin_Robot - کانال: t.me/salatin_plato - گروه: @Gap_Plato\n\n"
    ...
    "ترفندای بیشتر تو t.me/salatin_plato منتظرته! 😎\n\n"
...
if __name__ == "__main__":
    asyncio.run(main())from telegram import Update, InlineKeyboardButton, InlineKeyboardMarkup, InlineQueryResultArticle, InputTextMessageContent, InputFile
from telegram.ext import Application, CommandHandler, ContextTypes, InlineQueryHandler, CallbackQueryHandler, MessageHandler, filters, ConversationHandler
import requests
from bs4 import BeautifulSoup
import json
